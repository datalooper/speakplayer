...
class WordPress_Radio_Taxonomy {
	static $taxonomy = 'genres';
	static $taxonomy_metabox_id = 'genretaxonomy';
	static $post_type= 'sounds';
	...
	public function add_meta_box() {  
		add_meta_box( 'mytaxonomy_id', 'Genres',array(__CLASS__,'metabox'), static::$post_type ,'side','core');
	}  
